  ...
  return (
      ...
      <div style={{background:`url("https://images.unsplash.com/photo-1543857261-f71238eb4188?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1174&q=80")`,backgroundPosition:"center",backgroundRepeat:"no-repeat",opacity:'inherit',backgroundSize:"cover"}}  class="hero min-h-screen bg-base-200 w-full ">
        <div  class="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <div>
            <h1 class="text-5xl font-medium text-white">Box Office News!</h1>
